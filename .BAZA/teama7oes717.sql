...
--
-- Host: 127.0.0.1
-- Czas generowania: 02 Gru 2014, 15:16
...
(3, 6, 1, '2014-12-02 12:40:04'),
(4, 6, 8, '2014-12-02 12:40:20');
...
--
-- Zrzut danych tabeli `fcategories`
--

INSERT INTO `fcategories` (`id`, `title`, `group_id`, `author_id`, `date`) VALUES
(1, 'Kategoria 1', 1, 3, '2014-12-04 00:00:00'),
(2, 'Kategoria 2', 1, 6, '2014-12-11 00:00:00');
...
--
-- Zrzut danych tabeli `fgroups`
--

INSERT INTO `fgroups` (`id`, `title`, `author_id`, `date`) VALUES
(1, 'Tytuł', 1, '2014-12-10 00:00:00');
...
ALTER TABLE `fcategories`
 ADD PRIMARY KEY (`id`), ADD KEY `group_id` (`group_id`), ADD KEY `author_id` (`author_id`), ADD KEY `author_id_2` (`author_id`);

--
-- Indexes for table `fcomments`
--
ALTER TABLE `fcomments`
 ADD PRIMARY KEY (`id`), ADD KEY `group_id` (`group_id`), ADD KEY `category_id` (`category_id`), ADD KEY `thread_id` (`thread_id`), ADD KEY `author_id` (`author_id`);
...
ALTER TABLE `fthreads`
 ADD PRIMARY KEY (`id`), ADD KEY `group_id` (`group_id`), ADD KEY `category_id` (`category_id`), ADD KEY `author_id` (`author_id`);
...
--
-- Ograniczenia dla tabeli `fcategories`
--
ALTER TABLE `fcategories`
ADD CONSTRAINT `fcategories_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `fgroups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fcategories_ibfk_2` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ograniczenia dla tabeli `fcomments`
--
ALTER TABLE `fcomments`
ADD CONSTRAINT `fcomments_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `fgroups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fcomments_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `fcategories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fcomments_ibfk_3` FOREIGN KEY (`thread_id`) REFERENCES `fthreads` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fcomments_ibfk_4` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ograniczenia dla tabeli `fgroups`
--
ALTER TABLE `fgroups`
ADD CONSTRAINT `fgroups_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Ograniczenia dla tabeli `fthreads`
--
ALTER TABLE `fthreads`
ADD CONSTRAINT `fthreads_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `fgroups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fthreads_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `fcategories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fthreads_ibfk_3` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
